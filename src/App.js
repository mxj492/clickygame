...
import { faBaseballBall, faBasketballBall, faSkating, faFutbol, faFootballBall, faTableTennis, faSkiing, faSwimmer, faHockeyPuck, faBowlingBall, faGolfBall, faVolleyballBall} from '@fortawesome/free-solid-svg-icons'
import GamePiece from './components/GamePiece';
import Nav from './components/Nav/Nav';

class App extends Component {
    state = {
        icons: [faBaseballBall, faBasketballBall, faSkating, faFutbol, faFootballBall, faTableTennis, faSkiing, faSwimmer, faHockeyPuck, faBowlingBall, faGolfBall, faVolleyballBall].sort(this.randomize),
        clicked: [],
        score: 0,
        highScore: 0,
        correct: undefined,
